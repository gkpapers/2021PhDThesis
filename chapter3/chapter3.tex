...
function or pathologies. Recent work has shown that variability in analytical decisions can lead to substantial
...
scientific computing, and how numerical analysis can be applied to typical analytical workflows. Overall, while the
...
\Foreword{With the computational and experimental backbones in place, this chapter sought to characterize the analytic
impact of numerical uncertainty and errors in the context of a realistic neuroimaging experiment. This leveraged the
computational infrastructures, neuroimaging pipelines, and perturbation techniques laid out in the previous chapters,
and applied to observe the stability of various commonly-used analytic techniques in network neuroscience.}
%----------------------------------------------------------------------------------------
...
\section{Subject-Specific Signal is Amplified While Off-Target Biases Are Reduced}
...
\section{Distributions of Graph Statistics Are Reliable, But Individual Statistics Are Not}
...
\clearpage
\section{Uncertainty in Brain-Phenotype Relationships}
