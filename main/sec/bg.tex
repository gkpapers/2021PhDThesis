...
exploration~\cite{valdes2005introduction}, and neuroimaging enables this exploration \textit{in vivo} in humans.
...
once~\cite{esteban2019fmriprep,garyfallidis2014dipy}.

For the purpose of this thesis, I have chosen to focus on the analysis of diffuion imaging, as it enables the creation
of structural connectivity maps of the brain. Typically~\cite{jenkinson2012fsl}
 applications presented
and explored in this thesis in particular are concerned with the analysis of Diffusion Weighted MRI (DWI, dMRI)

\subsubsection{Diffusion \& Structural MRI Processing}
\begin{itemize}
\item concept
