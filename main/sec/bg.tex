...
error is measurable for an arbitrary problem, the mixed stability is commonly evaluated.
...
this thesis the estimation of significant digits through MCA had not been applied to the study of stability in
