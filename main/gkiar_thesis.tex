...
\hypersetup{hidelinks,colorlinks,breaklinks=true,urlcolor=color2,citecolor=color1,linkcolor=color1,bookmarksopen=false,pdftitle={Your Brain on Disk},pdfauthor={Gregory Kiar}}
...
\AbstractFR{mon abstract est superb}
...
\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},
            addtotoc={1,part,1,A Serverless Tool for Platform Agnostic Computational Experiment Management,ch1p1,   
...
\beginchapter{II}
\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},
            addtotoc={1,part,1,Comparing Perturbation Models for Evaluating Stability of Neuroimaging Pipelines,ch2p1,
...
\beginchapter{III}
\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},
            addtotoc={1,part,1,Numerical Instabilities in Analytical Pipelines Lead to Large and Meaningful \\ Variability in Brain Networks,ch3p1,
            ...
            addtolist={4, figure,\qquad\qquad Exploration of perturbation-induced deviations from reference connectomes, ch3f1,
                       5, table, \qquad\qquad {The impact of instabilities as evaluated through the separability of the dataset}, ch3t1,
                       8, figure,\qquad\qquad Distribution and stability assessment of multivariate graph statistics, ch3f2,
                       9, figure,\qquad\qquad Variability in BMI classification across the sampling of an MCA-perturbed dataset, ch3f3,
...
\beginchapter{IV}
\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},
            addtotoc={1,part,1,Data Augmentation Through Monte Carlo Arithmetic Leads to More Generalizable Classification in Connectomics,ch4p1,
            ...
            addtolist={4, figure,\qquad\qquad Experiment workflow., ch4f1,
                       ...
                       10, figure,\qquad\qquad Relative change in classifier performance with respect to classifier type and dataset sampling strategies, ch4f2,
                       11, figure,\qquad\qquad Relationship between generalizability and resampling, ch4f3,
                       12, figure,\qquad\qquad The generalizability of classifiers using each dataset sampling technique with respect to the number of MCA simulations, ch4f4}]
