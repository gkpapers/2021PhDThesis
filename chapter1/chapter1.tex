...
\Foreword{As was summarized in the sections above, a core objective of this thesis was to facilitate the
reproducible deployment and stability evaluation of neuroimaging tools. This chapter introduces Clowdr, a tool which
was developed to address the creation and evaluation of reproducible workflows. This technical contribution not only
addressed one core aim of this thesis, but was essential for enabling all subsequent experiments and explorations.}
